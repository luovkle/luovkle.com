...
def get_header_path(title: str) -> Path:
...
def get_post_data_from_md_file(md_file: Path) -> dict:
    ...
    header = get_header_path(md_post.title).relative_to(STATIC_RELATIVE_DIR)
...
def get_project_data_from_md_file(md_file: Path) -> dict:
    ...
    header = get_header_path(md_project.title).relative_to(STATIC_RELATIVE_DIR)
